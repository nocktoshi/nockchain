//! Web explorer JSON exposes `%memo` and `%blob-data` note-data entries as **standard Base64**
...
/// Explorer snapshot: jam bytes for `%blob-data` (`nns/v1/claim/nns.nock`).
