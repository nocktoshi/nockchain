                    ...
                    match i {
                        ...
                        5 => {
                            super::replace_screen(
                                store,
                                Screen::TextPrompt {
                                    title: "NNS name (e.g. myname or myname.nock)".into(),
                                    value: String::new(),
                                    then: TextThen::NnsRegisterName,
                                },
                            );
                        }
                        6 => super::replace_screen(store, Screen::Main { sel: 0 }),
                        _ => {
                            super::replace_screen(store, Screen::Transactions { sel });
                        }
                    }
                    ...
                    match i {
                        0 => {
                            ...
                            super::replace_screen(
                                store,
                                Screen::TextPrompt {
                                    title: "Public gRPC server (host[:port] or URI)".into(),
                                    value: session.public_grpc_server_addr,
                                    then: TextThen::SettingsGrpcEndpoint,
                                },
                            );
                        }
                        1 => {
                            ...
                            super::replace_screen(
                                store,
                                Screen::TextPrompt {
                                    title: "JSON API listen (host:port)".into(),
                                    value: session.api_listen,
                                    then: TextThen::SettingsApiListen,
                                },
                            );
                        }
                        2 => {
                            ...
                            store.state.panel_focus = PanelFocus::Output;
                            super::replace_screen(store, Screen::Settings { sel });
                        }
                        3 => {
