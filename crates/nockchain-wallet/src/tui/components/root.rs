...
use crate::tui::app_state::{status_modal_visible, AppState};
use crate::tui::prompt_overlay::{activity_underlay, has_prompt_overlay};
use crate::tui::screens::{Screen, SendSimplePhase};

pub(crate) fn draw_ui(f: &mut Frame<'_>, store: &mut crate::tui::store::UIStore) {
...
fn draw_activity_panel(
    f: &mut Frame<'_>,
    app: &mut AppState,
    session: &crate::tui::wallet_api::WalletSessionState,
